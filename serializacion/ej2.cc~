...
{
	const char * readerPath = "./ejercicio1.txt";
	int readFileDescriptor = open(readerPath, O_RDONLY);

	char buf[MAX_NAME * sizeof(char) + 2 * sizeof(int16_t];
	int copiedBytes = read(readFileDescriptor, buf, sizeof(buf));
